// Element-wise operations for f64 arrays
...
@group(0) @binding(0) var<storage, read> unary_input: array<f64>;
@group(0) @binding(1) var<storage, read_write> unary_output: array<f64>;
@group(0) @binding(2) var<uniform> unary_params: BinaryOpParams;

// Bindings for transpose operations
@group(0) @binding(0) var<storage, read> transpose_input: array<f64>;
@group(0) @binding(1) var<storage, read_write> transpose_output: array<f64>;
