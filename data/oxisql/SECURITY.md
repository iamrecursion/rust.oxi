...
OxiSQL follows the COOLJAPAN ecosystem's rolling-release model. Only
...
This policy covers the OxiSQL crate(s) published from this repository
(https://github.com/cool-japan/oxisql). Vulnerabilities in upstream
