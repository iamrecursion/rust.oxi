...
OxiH5 follows the COOLJAPAN ecosystem's rolling-release model. Only the
**latest released 0.x line** is supported with security fixes. Older
0.x releases do not receive backported patches; please upgrade to the
latest release before reporting an issue to confirm it is still
reproducible.
...
This policy covers the OxiH5 crate(s) published from this repository
(https://github.com/cool-japan/oxih5). Vulnerabilities in upstream
