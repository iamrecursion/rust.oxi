//! Error type definitions for OxiGeo
...
impl From<IoError> for OxiGeoError {
    fn from(err: IoError) -> Self {
        Self::Io(err)
    }
}

impl From<FormatError> for OxiGeoError {
    fn from(err: FormatError) -> Self {
        Self::Format(err)
    }
}

impl From<CrsError> for OxiGeoError {
    fn from(err: CrsError) -> Self {
        Self::Crs(err)
    }
}

impl From<CompressionError> for OxiGeoError {
...
#[cfg(feature = "std")]
impl From<std::io::Error> for OxiGeoError {
    fn from(err: std::io::Error) -> Self {
        Self::Io(err.into())
    }
}
...
#[cfg(not(feature = "std"))]
impl fmt::Display for OxiGeoError {
