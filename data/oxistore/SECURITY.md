...
OxiStore follows the COOLJAPAN ecosystem's rolling-release model. Only
...
This policy covers the OxiStore crate(s) published from this
repository (https://github.com/cool-japan/oxistore). Vulnerabilities
