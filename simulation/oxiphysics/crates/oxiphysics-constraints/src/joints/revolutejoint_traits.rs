//! # RevoluteJoint - Trait Implementations
//!
//! This module contains trait implementations for `RevoluteJoint`.
//!
//! ## Implemented Traits
//!
//! - `Constraint`
...
impl Constraint for RevoluteJoint {
    ...
    fn solve_velocity(&mut self, bodies: &mut RigidBodySet, _dt: f64) {
        ...
        let free_component = d_omega.dot(&self.world_axis) * self.world_axis;
        let constrained_omega = d_omega - free_component;
