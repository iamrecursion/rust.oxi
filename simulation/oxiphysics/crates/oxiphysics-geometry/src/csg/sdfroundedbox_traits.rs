//! # SdfRoundedBox - Trait Implementations
//!
//! This module contains trait implementations for `SdfRoundedBox`.
//!
//! ## Implemented Traits
//!
//! - `ImplicitSurface`
...
use super::types::SdfRoundedBox;

impl ImplicitSurface for SdfRoundedBox {
