...
// solver records every certified theory conflict into the tracker
// (`solver::inprocess::record_theory_conflict_vars`, called from
// `install_theory_conflict`) and boosts the involved variables' activity. Some
// analysis helpers (analyze_patterns / get_ranked_variables) remain unused,
