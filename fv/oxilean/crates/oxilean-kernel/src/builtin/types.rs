...
impl BuiltinKind {
    ...
    pub fn description(&self) -> &'static str {
        match self {
            BuiltinKind::Type => "primitive type",
            BuiltinKind::Constructor => "type constructor",
            BuiltinKind::Recursor => "recursor/eliminator",
            BuiltinKind::Axiom => "logical axiom",
            BuiltinKind::ArithOp => "arithmetic operation",
            BuiltinKind::CmpOp => "comparison operation",
            BuiltinKind::StringOp => "string operation",
            BuiltinKind::TypeClass => "type class",
            BuiltinKind::Unknown => "not a builtin",
        }
    }
}
/// A write-once cell.
