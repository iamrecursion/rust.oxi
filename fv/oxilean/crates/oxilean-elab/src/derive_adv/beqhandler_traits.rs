//! # BEqHandler - Trait Implementations
//!
//! This module contains trait implementations for `BEqHandler`.
//!
//! ## Implemented Traits
//!
//! - `Default`
...
use super::types::{AdvDeriveError, AdvDeriveResult, BEqHandler, TypeInfoAdv};

impl Default for BEqHandler {
    fn default() -> Self {
        Self::new()
    }
}

impl DeriveHandler for BEqHandler {
