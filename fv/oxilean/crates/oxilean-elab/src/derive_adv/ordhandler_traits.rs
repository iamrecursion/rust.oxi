//! # OrdHandler - Trait Implementations
//!
//! This module contains trait implementations for `OrdHandler`.
//!
//! ## Implemented Traits
//!
//! - `Default`
...
use super::types::{AdvDeriveError, AdvDeriveResult, OrdHandler, TypeInfoAdv};

impl Default for OrdHandler {
    fn default() -> Self {
        Self::new()
    }
}

impl DeriveHandler for OrdHandler {
