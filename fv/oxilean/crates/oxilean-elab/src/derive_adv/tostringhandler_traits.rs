//! # ToStringHandler - Trait Implementations
//!
//! This module contains trait implementations for `ToStringHandler`.
//!
//! ## Implemented Traits
//!
//! - `Default`
...
use super::types::{AdvDeriveError, AdvDeriveResult, ToStringHandler, TypeInfoAdv};

impl Default for ToStringHandler {
    fn default() -> Self {
        Self::new()
    }
}

impl DeriveHandler for ToStringHandler {
