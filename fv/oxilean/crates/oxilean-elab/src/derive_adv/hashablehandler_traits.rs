//! # HashableHandler - Trait Implementations
//!
//! This module contains trait implementations for `HashableHandler`.
//!
//! ## Implemented Traits
//!
//! - `Default`
...
use super::types::{AdvDeriveError, AdvDeriveResult, HashableHandler, TypeInfoAdv};

impl Default for HashableHandler {
    fn default() -> Self {
        Self::new()
    }
}

impl DeriveHandler for HashableHandler {
