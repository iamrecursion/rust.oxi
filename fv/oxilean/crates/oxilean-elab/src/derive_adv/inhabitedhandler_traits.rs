//! # InhabitedHandler - Trait Implementations
//!
//! This module contains trait implementations for `InhabitedHandler`.
//!
//! ## Implemented Traits
//!
//! - `Default`
...
use super::types::{AdvDeriveError, AdvDeriveResult, InhabitedHandler, TypeInfoAdv};

impl Default for InhabitedHandler {
    fn default() -> Self {
        Self::new()
    }
}

impl DeriveHandler for InhabitedHandler {
