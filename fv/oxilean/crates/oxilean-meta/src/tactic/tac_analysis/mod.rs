//! TacticMod analysis infrastructure: results, passes, pipelines, configs, diagnostics.
//! Also includes ModExt2700 extended analysis utilities.
...
// ── TacticModConfigValue / TacticModConfig ────────────────────────────────────
...
pub struct TacticModConfig {
    pub values: HashMap<String, TacticModConfigValue>,
    pub read_only: bool,
}
...
/// Extended analysis result (2700 variant).
#[allow(dead_code)]
#[derive(Debug, Clone)]
...
/// Extended analysis pass (2700 variant).
#[allow(dead_code)]
...
/// Extended pipeline (2700 variant).
#[allow(dead_code)]
...
/// Extended config value (2700 variant).
#[allow(dead_code)]
#[derive(Debug, Clone)]
...
/// Extended config store (2700 variant).
#[allow(dead_code)]
pub struct ModExtConfig2700 {
    pub(super) values: HashMap<String, ModExtConfigVal2700>,
...
/// Extended diagnostic reporter (2700 variant).
#[allow(dead_code)]
