...
pub struct SRX2PassRegistry {
    pub(crate) configs: Vec<SRX2PassConfig>,
    pub(crate) stats: Vec<SRX2PassStats>,
}
...
pub struct OSPassRegistry {
    pub(crate) configs: Vec<OSPassConfig>,
    pub(crate) stats: std::collections::HashMap<String, OSPassStats>,
}
impl OSPassRegistry {
    #[allow(dead_code)]
    pub fn new() -> Self {
