...
OxiQUIC follows the COOLJAPAN ecosystem's rolling-release model. Only
...
This policy covers the OxiQUIC crate(s) published from this repository
(https://github.com/cool-japan/oxiquic). Vulnerabilities in upstream
