...
* By opening a confidential report via
  [GitHub Security Advisories](https://github.com/cool-japan/mielin/security/advisories/new)
  for the `cool-japan/mielin` repository, which is visible only to the
  reporter and the project maintainers, **or**
* By contacting the maintainers (**COOLJAPAN OU / Team Kitasan**) through the
  [COOLJAPAN organization on GitHub](https://github.com/cool-japan).
