...
pub enum EntryType {
    ...
    /// Named pipe (fifo)
    Fifo,
    /// Implementation-defined 'high-performance' type, treated as regular
    /// file
    Continuous,
...
impl EntryType {
    ...
    /// Returns whether this type represents PAX global extensions.
