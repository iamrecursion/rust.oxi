//! Tiny JPEG datastreams used by this crate's documentation examples, its own
//! tests and downstream crates' tests.
//!
//! All three were produced by `cjpeg -quality 75` from a one-pixel grey PGM,
//! and the abbreviated pair was split out of the interchange stream exactly as
//! TIFF's `Compression = 7` splits one: the tables-only stream keeps `DQT` and
//! `DHT`, the scan-only stream keeps `SOF` and `SOS` plus the entropy data,
//! and each is wrapped in its own `SOI` ... `EOI`.

/// A complete one-pixel greyscale baseline JPEG interchange stream.
pub const GRAY_1X1: [u8; 331] = [
...
/// The tables-only half of [`GRAY_1X1`], shaped like TIFF tag 347.
pub const GRAY_1X1_TABLES: [u8; 289] = [
...
/// The scan-only half of [`GRAY_1X1`], shaped like one TIFF strip.
pub const GRAY_1X1_SCAN: [u8; 28] = [
    0xFF, 0xD8, 0xFF, 0xC0, 0x00, 0x0B, 0x08, 0x00, 0x01, 0x00, 0x01, 0x01, 0x01, 0x11, 0x00, 0xFF,
    0xDA, 0x00, 0x08, 0x01, 0x01, 0x00, 0x00, 0x3F, 0x00, 0x2B, 0xFF, 0xD9,
];
/// An eight-by-eight RGB baseline JPEG at 4:2:0, one MCU exactly.
pub const RGB_8X8_420: [u8; 665] = [
    0xFF, 0xD8, 0xFF, 0xE0, 0x00, 0x10, 0x4A, 0x46, 0x49, 0x46, 0x00, 0x01, 0x01, 0x00, 0x00, 0x01,
    0x00, 0x01, 0x00, 0x00, 0xFF, 0xDB, 0x00, 0x43, 0x00, 0x08, 0x06, 0x06, 0x07, 0x06, 0x05, 0x08,
    0x07, 0x07, 0x07, 0x09, 0x09, 0x08, 0x0A, 0x0C, 0x14, 0x0D, 0x0C, 0x0B, 0x0B, 0x0C, 0x19, 0x12,
    0x13, 0x0F, 0x14, 0x1D, 0x1A, 0x1F, 0x1E, 0x1D, 0x1A, 0x1C, 0x1C, 0x20, 0x24, 0x2E, 0x27, 0x20,
    ...
    0xFA, 0xFF, 0xDA, 0x00, 0x0C, 0x03, 0x01, 0x00, 0x02, 0x11, 0x03, 0x11, 0x00, 0x3F, 0x00, 0xCB,
    0xF0, 0xFF, 0x00, 0x81, 0x55, 0x15, 0x59, 0xA3, 0xC0, 0x1D, 0xF1, 0x45, 0x14, 0x57, 0x99, 0x9A,
    0xE7, 0x98, 0x8C, 0xBA, 0x70, 0xA7, 0x46, 0x31, 0x69, 0xAB, 0xEB, 0x7E, 0xFE, 0x4D, 0x1B, 0x64,
    0x59, 0x9E, 0x26, 0x78, 0x44, 0xDC, 0x8F, 0xFF, 0xD9,
];

/// The tables-only half of [`RGB_8X8_420`], shaped like TIFF tag 347.
pub const RGB_8X8_420_TABLES: [u8; 574] = [
    0xFF, 0xD8, 0xFF, 0xDB, 0x00, 0x43, 0x00, 0x08, 0x06, 0x06, 0x07, 0x06, 0x05, 0x08, 0x07, 0x07,
    0x07, 0x09, 0x09, 0x08, 0x0A, 0x0C, 0x14, 0x0D, 0x0C, 0x0B, 0x0B, 0x0C, 0x19, 0x12, 0x13, 0x0F,
    0x14, 0x1D, 0x1A, 0x1F, 0x1E, 0x1D, 0x1A, 0x1C, 0x1C, 0x20, 0x24, 0x2E, 0x27, 0x20, 0x22, 0x2C,
    0x23, 0x1C, 0x1C, 0x28, 0x37, 0x29, 0x2C, 0x30, 0x31, 0x34, 0x34, 0x34, 0x1F, 0x27, 0x39, 0x3D,
...
/// The scan-only half of [`RGB_8X8_420`], shaped like one TIFF strip.
pub const RGB_8X8_420_SCAN: [u8; 77] = [
    0xFF, 0xD8, 0xFF, 0xC0, 0x00, 0x11, 0x08, 0x00, 0x08, 0x00, 0x08, 0x03, 0x01, 0x22, 0x00, 0x02,
    0x11, 0x01, 0x03, 0x11, 0x01, 0xFF, 0xDA, 0x00, 0x0C, 0x03, 0x01, 0x00, 0x02, 0x11, 0x03, 0x11,
    0x00, 0x3F, 0x00, 0xCB, 0xF0, 0xFF, 0x00, 0x81, 0x55, 0x15, 0x59, 0xA3, 0xC0, 0x1D, 0xF1, 0x45,
    0x14, 0x57, 0x99, 0x9A, 0xE7, 0x98, 0x8C, 0xBA, 0x70, 0xA7, 0x46, 0x31, 0x69, 0xAB, 0xEB, 0x7E,
    0xFE, 0x4D, 0x1B, 0x64, 0x59, 0x9E, 0x26, 0x78, 0x44, 0xDC, 0x8F, 0xFF, 0xD9,
];
