//! Standard RDF vocabularies for OxiRS
//! 
//! Provides ready-to-use NamedNodeRef constants for basic RDF vocabularies.
//! Extracted from OxiGraph oxrdf and adapted for OxiRS architecture.
...
pub mod xsd {
    ...
    /// 64-bit floating point numbers incl. ±Inf and NaN.
    ...
    /// 32-bit floating point numbers incl. ±Inf and NaN.
    ...
    /// XML NCName.
    pub const NCNAME: NamedNodeRef<'_> =
...
mod tests {
    ...
    fn test_rdf_vocabulary() {
        ...
        assert_eq!(rdf::FIRST.as_str(), "http://www.w3.org/1999/02/22-rdf-syntax-ns#first");
        assert_eq!(rdf::REST.as_str(), "http://www.w3.org/1999/02/22-rdf-syntax-ns#rest");
        assert_eq!(rdf::NIL.as_str(), "http://www.w3.org/1999/02/22-rdf-syntax-ns#nil");
    }

    #[test]
    fn test_rdfs_vocabulary() {
        assert_eq!(rdfs::CLASS.as_str(), "http://www.w3.org/2000/01/rdf-schema#Class");
        assert_eq!(rdfs::DOMAIN.as_str(), "http://www.w3.org/2000/01/rdf-schema#domain");
        assert_eq!(rdfs::RANGE.as_str(), "http://www.w3.org/2000/01/rdf-schema#range");
        assert_eq!(rdfs::SUB_CLASS_OF.as_str(), "http://www.w3.org/2000/01/rdf-schema#subClassOf");
    }

    #[test]
    fn test_xsd_vocabulary() {
        ...
        assert_eq!(xsd::BOOLEAN.as_str(), "http://www.w3.org/2001/XMLSchema#boolean");
        assert_eq!(xsd::DATE_TIME.as_str(), "http://www.w3.org/2001/XMLSchema#dateTime");
    }
}