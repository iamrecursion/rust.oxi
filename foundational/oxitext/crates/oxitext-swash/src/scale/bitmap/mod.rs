// OXITEXT MODIFICATION (oxitext 0.2.2): one `explicit_counter_loop` (`dy`
// folded into the iterator) plus the `cfg` correction marked inline below.
// See ../../../PROVENANCE.md.
//! Bitmap scaling.
...
pub fn blit(
    ...
    for (dy, sy) in (dest_y..).zip(source_columns) {
