// OXITEXT MODIFICATION (oxitext 0.2.2): 1 `.unwrap()` site converted to a
// `let ... else` (D13 -- a font parser reads untrusted bytes and must not panic
// on them). See ../../PROVENANCE.md.
/*!
