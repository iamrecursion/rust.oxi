...
// swash::` to `use oxitext_swash::` (2 sites) -- the vendored crate keeps the
// default lib name `oxitext_swash`, so upstream's doctests would not resolve.
// No non-doc code changed. See ../PROVENANCE.md.
...
/// ```
/// use oxitext_swash::{Attributes, CacheKey, Charmap, FontRef};
///
/// pub struct Font {
