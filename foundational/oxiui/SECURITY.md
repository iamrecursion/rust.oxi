...
OxiUI follows the COOLJAPAN ecosystem's rolling-release model. Only the
...
This policy covers the OxiUI crate(s) published from this repository
(https://github.com/cool-japan/oxiui). Vulnerabilities in upstream
