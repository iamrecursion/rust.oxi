...
impl QuantumChemistryOptimizer {
    ...
    pub fn calculate_reaction_energetics(
        ...
        let activation_energy = if let Some(ts_energy) = transition_state_energy {
            ...
            0.3f64.mul_add(reaction_energy.abs(), 20.0)
        };
        ...
        Ok(ReactionEnergetics {
            ...
            reaction_energy,
            activation_energy,
            reaction_enthalpy: reaction_energy,
            reaction_entropy,
        })
    }
    /// Private helper methods
    pub(crate) fn molecular_system_to_qubo(
        &self,
        system: &MolecularSystem,
        ...
        for objective in objectives {
            let score = match objective {
                CatalysisObjective::MinimizeActivationEnergy => {
                    -energetics.activation_energy / 100.0
                }
...
pub struct BasisFunction {
    ...
    pub angular_momentum: (u32, i32, i32),
    /// Exponent
    pub exponent: f64,
