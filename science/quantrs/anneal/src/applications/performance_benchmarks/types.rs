...
use crate::applications::unified::{
    ProblemComplexity, SolverConfiguration, SolverType, UnifiedSolverFactory,
};
use crate::applications::{ApplicationError, ApplicationResult, ProblemCategory};
...
impl PerformanceBenchmarkSuite {
    ...
    pub fn create_benchmark_problem_config(
        &self,
        industry: &str,
        size: usize,
    ...
    pub const fn apply_temperature_profile(
        &self,
    ...
    pub fn gather_system_info() -> SystemInfo {
        SystemInfo {
            ...
            cpu_info: CPUInfo {
                ...
                cache_sizes_mb: vec![0.032, 0.256, 8.0],
            },
        ...
        for industry in &self.config.benchmark_industries {
            ...
            if !industry_results.is_empty() {
                ...
                let analysis = IndustryAnalysis {
                    ...
                    best_solver: SolverType::Classical,
    ...
    pub(crate) fn generate_performance_report(&self) -> ApplicationResult<String> {
...
pub struct HardwareMetrics {
    ...
    pub memory_usage_timeline: Vec<(f64, f64)>,
    /// CPU usage over time
    pub cpu_usage_timeline: Vec<(f64, f64)>,
