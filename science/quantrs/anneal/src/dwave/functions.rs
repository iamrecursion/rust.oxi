...
mod client {
    ...
    impl AnnealingSchedule {
        ...
        pub fn linear(annealing_time: f64) -> Self {
            Self {
                schedule: vec![(0.0, 1.0), (annealing_time, 0.0)],
            }
        }
    ...
    impl DWaveClient {
        ...
        pub fn with_config(
            ...
            Ok(Self {
                ...
                problem_timeout: Duration::from_secs(1800),
            })
        }
            ...
            let filtered_solvers: Vec<_> = solvers
                ...
                .filter(|solver| {
                    let category_match = match selector.category {
                        ...
                        SolverCategory::Hybrid => {
                            matches!(solver.solver_type, SolverType::Hybrid)
                        }
        ...
        fn embed_problem(
            ...
            let mut embedded_model = IsingModel::new(0);
