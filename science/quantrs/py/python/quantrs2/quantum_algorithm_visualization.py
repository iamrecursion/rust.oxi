...
# Orchestrator, convenience functions, GUI, and CLI moved to
# quantum_algorithm_visualization_extended.py for compliance with the
# 2000-line file policy. Re-exported here for backwards compatibility.
from .quantum_algorithm_visualization_extended import (
