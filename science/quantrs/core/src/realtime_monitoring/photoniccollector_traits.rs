//! # PhotonicCollector - Trait Implementations
//!
//! This module contains trait implementations for `PhotonicCollector`.
//!
//! ## Implemented Traits
//!
//! - `MetricCollector`
...
use super::types::{MetricMeasurement, MetricType, PhotonicCollector};
