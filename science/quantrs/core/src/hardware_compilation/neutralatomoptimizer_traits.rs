//! # NeutralAtomOptimizer - Trait Implementations
//!
//! This module contains trait implementations for `NeutralAtomOptimizer`.
//!
//! ## Implemented Traits
//!
//! - `PlatformOptimizer`
...
use super::types::{
    CompiledGate, ErrorModel, HardwareCompilationConfig, NeutralAtomOptimizer, OptimizationMetrics,
    OptimizedSequence, PlatformConstraints, TimingConstraints,
};
