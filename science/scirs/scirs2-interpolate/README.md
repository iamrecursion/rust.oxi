...
**Advanced interpolation and approximation for the SciRS2 scientific computing library (v0.6.6).**
...
```toml
[dependencies]
scirs2-interpolate = { version = "0.6.6", features = ["simd", "linalg"] }
```
