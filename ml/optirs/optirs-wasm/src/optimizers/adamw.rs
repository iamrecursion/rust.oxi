//! WASM wrapper for the AdamW optimizer.
...
/// WASM-compatible wrapper for the AdamW optimizer.
...
impl WasmAdamW {
    ...
    /// Create a new AdamW optimizer with full configuration.
    pub fn new_with_config(
        ...
        Self {
            inner: AdamW::new_with_config(lr, beta1, beta2, epsilon, weight_decay),
        }
    }
