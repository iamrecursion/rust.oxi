//! WASM wrapper for the RAdam optimizer.

use crate::types::{array1_to_vec, slice_to_array1};
use optirs_core::optimizers::{Optimizer, RAdam};
use scirs2_core::ndarray::Ix1;

#[cfg(feature = "wasm")]
use wasm_bindgen::prelude::*;

/// WASM-compatible wrapper for the RAdam optimizer.
#[cfg_attr(feature = "wasm", wasm_bindgen)]
pub struct WasmRAdam {
    inner: RAdam<f64>,
}

#[cfg_attr(feature = "wasm", wasm_bindgen)]
impl WasmRAdam {
    /// Create a new RAdam optimizer with the given learning rate.
    ...
    /// Create a new RAdam optimizer with full configuration.
    pub fn new_with_config(
        ...
        Self {
            inner: RAdam::new_with_config(lr, beta1, beta2, epsilon, weight_decay),
        }
    }
