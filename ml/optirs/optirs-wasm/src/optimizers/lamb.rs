//! WASM wrapper for the LAMB optimizer.

use crate::types::{array1_to_vec, slice_to_array1};
use optirs_core::optimizers::{Optimizer, LAMB};
use scirs2_core::ndarray::Ix1;

#[cfg(feature = "wasm")]
use wasm_bindgen::prelude::*;

/// WASM-compatible wrapper for the LAMB optimizer.
...
#[cfg_attr(feature = "wasm", wasm_bindgen)]
impl WasmLAMB {
    /// Create a new LAMB optimizer with the given learning rate.
    ...
    /// Create a new LAMB optimizer with full configuration.
    pub fn new_with_config(
        ...
        Self {
            inner: LAMB::new_with_config(lr, beta1, beta2, epsilon, weight_decay, bias_correction),
        }
    }
