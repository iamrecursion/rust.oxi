...
fn main() {
    ...
    for epoch in 0..5 {
        ...
        current_params = optimizer
            .step(&current_params, &gradients)
            .expect("unwrap failed");
