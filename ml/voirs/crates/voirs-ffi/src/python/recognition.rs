//! Speech recognition bindings for Python
...
// Re-export at module level for public use
#[cfg(feature = "recognition")]
pub use recognition_bindings::{
    PyASRModel, PyAudioAnalysis, PyAudioAnalyzer, PyPerformanceMetrics, PyPhonemeAlignment,
