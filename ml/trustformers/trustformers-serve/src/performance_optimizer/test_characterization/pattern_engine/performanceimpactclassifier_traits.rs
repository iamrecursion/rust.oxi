//! # PerformanceImpactClassifier - Trait Implementations
//!
//! This module contains trait implementations for `PerformanceImpactClassifier`.
//!
//! ## Implemented Traits
//!
//! - `Default`
...
use super::types::{
    ClassificationResult, ClassifierMetadata, PatternCategory, PerformanceImpactClassifier,
};
