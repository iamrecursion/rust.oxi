# Complete AWS EKS module for TrustformeRS Serve
# Provides a production-ready EKS cluster with all necessary components
...
# Additional cluster permissions for advanced features
...
# Additional node group permissions
...
resource "aws_security_group" "additional" {
  count       = length(var.additional_security_group_rules) > 0 ? 1 : 0
...
# Install essential cluster components via Helm
...
# Install TrustformeRS Serve via Helm
