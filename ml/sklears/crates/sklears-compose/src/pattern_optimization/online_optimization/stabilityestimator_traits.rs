//! # StabilityEstimator - Trait Implementations
//!
//! This module contains trait implementations for `StabilityEstimator`.
//!
//! ## Implemented Traits
//!
//! - `Default`
...
use super::types::StabilityEstimator;

impl Default for StabilityEstimator {
    fn default() -> Self {
        Self {
            stability_metrics: HashMap::new(),
            estimation_window: Duration::from_secs(3600),
